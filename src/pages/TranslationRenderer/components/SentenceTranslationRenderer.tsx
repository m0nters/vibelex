  ...
  return (
    ...
    >
      <button
        ...
        className={`shrink-0 cursor-pointer rounded-full bg-blue-400 transition-all duration-300 dark:bg-blue-500 ${isExpanded ? "mt-1 mr-2 h-6 w-1" : "mt-2 mr-0 h-3 w-3 -translate-x-1"}`}
      />
