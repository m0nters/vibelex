...
export function ApiKeyForm({
  ...
  return (
    <form onSubmit={onSubmit}>
      <div className="rounded-2xl border-2 border-gray-200 bg-white p-5 shadow-sm transition-colors duration-300 dark:border-slate-700 dark:bg-slate-800">
        ...
        <div
          className={`mt-2 overflow-hidden text-xs text-red-600 transition-colors duration-300 dark:text-red-400 ${error ? "max-h-20" : "max-h-0"}`}
        >
        ...
        <button
          type="submit"
          className="mt-2 w-full cursor-pointer rounded-xl bg-linear-to-r from-indigo-500 to-purple-500 py-3 text-sm font-semibold text-white shadow-md transition-colors duration-300 hover:from-indigo-600 hover:to-purple-600 hover:shadow-lg active:scale-95"
        >
