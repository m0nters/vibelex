...
export function ApiKeyGuide() {
  ...
  return (
    <>
      ...
      <div className="mt-4 rounded-xl border border-indigo-200/50 bg-linear-to-r from-indigo-500/10 to-purple-500/10 p-4 dark:border-indigo-400/20 dark:from-indigo-400/10 dark:to-purple-400/10">
        <h3 className="mb-3 flex items-center space-x-2 text-sm font-semibold text-indigo-700 dark:text-indigo-300">
