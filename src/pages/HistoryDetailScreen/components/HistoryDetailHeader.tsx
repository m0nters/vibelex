...
export function HistoryDetailHeader({
  ...
  return (
    <div className="sticky top-0 z-10 border-b border-indigo-100 bg-white/70 backdrop-blur-sm select-none dark:border-slate-800 dark:bg-slate-900/70">
      <div className="flex items-center justify-between p-4">
        <div className="flex min-w-0 items-center space-x-2">
          ...
          <div className="min-w-0">
            ...
            <p
              className="truncate text-xs text-gray-500 select-text dark:text-slate-400"
