...
export function PopupTopBar({
  ...
  return (
    <div
      className="sticky top-0 z-10 flex items-center justify-between bg-white/70 px-4 py-2 backdrop-blur-sm dark:bg-slate-900/70"
      id="close-button"
    >
      ...
      <button
        onClick={onClose}
        className="flex cursor-pointer rounded-full p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 dark:text-slate-500 dark:hover:bg-slate-800 dark:hover:text-slate-300"
      >
        <X className="h-4 w-4" />
      </button>
    </div>
