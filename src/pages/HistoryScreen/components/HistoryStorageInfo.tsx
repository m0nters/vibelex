      ...
      <div className="flex items-center justify-between">
        ...
        {!isFromStatistics ? (
          ...
          >
            ...
            >
              <ChartPie className="h-4 w-4 shrink-0 text-indigo-600 transition-colors duration-300 dark:text-indigo-400" />
              <span className="truncate text-sm font-medium text-indigo-600 transition-colors duration-300 dark:text-indigo-400">
            ...
            >
              <HardDrive className="h-4 w-4 shrink-0 text-gray-500 transition-colors duration-300 dark:text-slate-400" />
              <span className="truncate text-sm font-medium text-gray-700 transition-colors duration-300 dark:text-slate-300">
        ...
        <div className="flex items-center space-x-3 text-xs text-gray-600 transition-colors duration-300 select-text sm:hidden dark:text-slate-400">
          <span
