        ...
        <div className="flex items-center justify-between p-4">
          ...
          {hasEntries && (
            <button
              ...
              className="flex cursor-pointer items-center space-x-1 rounded-lg border border-red-200 bg-red-50 px-3 py-1.5 text-xs text-red-500 transition-all duration-300 hover:bg-red-100 hover:shadow-sm dark:border-red-900/50 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40"
            >
          ...
          <div className="relative">
            ...
            {searchQuery && (
              <button
                ...
                title="Clear search"
              >
                <X className="h-4 w-4 text-gray-400 transition-colors duration-300 hover:text-gray-600 dark:text-slate-500 dark:hover:text-slate-300" />
              </button>
            )}
          </div>
        </div>
