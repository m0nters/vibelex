...
export function HistoryBulkActions({
  ...
  return (
    <div className="sticky top-[164px] z-10 mx-4 mt-2 rounded-xl border border-indigo-300 bg-indigo-50 p-3 shadow-sm dark:border-indigo-900/50 dark:bg-slate-800">
      <div className="flex justify-between">
        ...
        <button
          ...
          className="h-fit cursor-pointer rounded-lg border border-red-300 bg-red-100 p-3 text-xs text-red-600 transition-all duration-200 hover:bg-red-200 hover:shadow-sm dark:border-red-900/50 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40"
        >
